...
(function () {
  ...
  var exact = {
    ...
    'BUY': 'КУПИТЬ', 'SELL': 'ПРОДАТЬ', 'PAY': 'ЗАПЛАТИТЬ', 'BORROW': 'ЗАНЯТЬ', 'ROLL': 'БРОСИТЬ',
    'ROLL 2x': 'БРОСИТЬ 2×', 'DONE': 'ГОТОВО', 'PASS': 'ПРОПУСТИТЬ', 'CONFIRM': 'ПОДТВЕРДИТЬ',
    'CANCEL': 'ОТМЕНА', 'RETURN': 'НАЗАД', 'BACK': 'НАЗАД', 'DONATE': 'ПОЖЕРТВОВАТЬ', 'YES': 'ДА', 'NO': 'НЕТ',
    'New Game': 'Новая игра', 'Play Again': 'Играть снова', 'END TURN': 'ЗАВЕРШИТЬ ХОД', 'ENTER FAST TRACK': 'ПЕРЕЙТИ НА БЫСТРУЮ ДОРОЖКУ',
